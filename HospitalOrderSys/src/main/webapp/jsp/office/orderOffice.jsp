			...
			<div class="row">
				<div class="col-md-12">
					...
					<form class="form-search form-horizontal" id="setchInfo"
						action="<c:url value='${mybasePath}orderOffice/1.do' />" method="post">
						<fieldset>
					...
					<div class="thumbnail" style="width: 300px; height: 200px;">
						...
						<div class="caption">
							...
							<p>
								 ...
								 <a class="btn"
									href="<c:url value='${mybasePath}officeInfoShow/${office.id}.do' />">详细信息</a>
...
<script type="text/javascript">
	function tijiao(url) {
		$("#setchInfo")
				.attr("action", "<c:url value='/orderOffice/"+url+".do' />");
		$("#setchInfo").submit();
		return false;
	}
</script>
