					...
					<div class="form-top">
						...
						<div class="pull-right-bottom">
								<p class="text-danger"
									...
									id="errorTip" value="${error}">${error}</p>
							</div>

					</div>
					<div class="form-bottom">
						<form role="form" action="${mybasePath }sign.do" method="post" class="login-form">
							<!--  
						...
						<span><a href="${mybasePath }jsp/user/findPassword.jsp">找回密码</a></span> <span><a
							href="${mybasePath }jsp/user/login.jsp" class="pull-right">用户登录</a></span>
					</div>
				</div>
			</div>
		</div>
