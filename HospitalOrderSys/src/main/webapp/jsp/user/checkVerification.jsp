				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="${mybasePath }checkVerification.do" method="post" class="login-form">
							...
							<span><a href="#"></a></span>&nbsp<span><a href="${mybasePath }jsp/user/findPassword.jsp"
