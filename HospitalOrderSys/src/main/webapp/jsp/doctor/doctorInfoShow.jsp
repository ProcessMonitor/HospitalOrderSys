	...
	<div id="page-wrapper" style="margin-top: 50px;">
		<div id="page-inner">
			...
			<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<a href="<c:url value='/hosInfoShow/${hos.id}.do' />"><p class="text-left">${hos.hospitalName }
						</p></a>
					</div>
					<div class="col-md-5">
						<p class="text-right">
					...
					<c:if test='${hos.isOpen=="1" }'>
						<div class="tab-pane fade active in text-left" id="home">
							...
							<form class="form-search form-horizontal" id="orderInfo"
								action="<c:url value='${mybasePath}order.do' />" method="post">
						...
						<div class="tab-pane fade text-left" id="orderNotice">
							...
							<p>
								...
								${hos.hospitalName }<br>注意：预约数据均为测试。
							</p>
						</div>
					</c:if>
