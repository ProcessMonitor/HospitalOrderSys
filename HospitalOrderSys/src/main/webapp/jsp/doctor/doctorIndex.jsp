...
<body>
	...
	<form class="form-search form-horizontal" id="setchInfo"
		action="<c:url value='/doctorIndex/1.do' />" method="post"></form>
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="nav navbar-nav navbar-right">
							<a href="/ssm_pro/allDoctor/1.do">查看更多医生</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="caption">
							...
							<p>
								...
								<a class="btn btn-primary"
									href="<c:url value='/doctorInfoShow/${doctor.id}.do' />">现在预约</a>
...
<script type="text/javascript">
	function tijiaoInput() {
		...
		$("#setchInfo")
				.attr("action", "<c:url value='/doctorIndex/"+url+".do' />");
		$("#setchInfo").submit();
		return false;
	}
</script>
