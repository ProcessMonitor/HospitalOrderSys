												...
												<div class="modal-content">
													...
													<div class="modal-footer">
														<form id="cancel" method="post"
															action="<c:url value="/cancelOrder/${orderRecords.id}.do"/>">
				...
				<div class="tab-pane fade text-left" id="userInfo">
					<div class="panel panel-primary text-left">
						...
						<div class="panel-body">
								...
								<div class="col-md-12 text-left">
									...
									<div
										...
										<select style="margin-bottom: 6px;"
											...
											<option value="${userInfo.userSex }" selected="selected">${userInfo.userSex }</option>
							...
							<div class="col-md-12">
								<div class="col-md-3">
									<h3>手机号：${userInfo.userMobile }</h3>
								</div>
								<div class="col-md-3">
									<h3>
										<a href="${mybasePath }modifiPhone.do">修改手机号码</a>
									</h3>
								</div>
							</div>
							<div class="col-md-12">
								<div class="col-md-12">
									<h3>邮箱：${userInfo.userEmail }</h3>
